...
const RecentMoves=(props)=>{
    ...
    async function getLastMoveData(data) { 
      ...
      storageData.slice().reverse().forEach((element,index) => {
        ...
        let obj={name:element.postName,cellNo:element.player.position-1,diceFace:element.dice.iDiceFace,diceRoll: element.iRoll,currentDiceFace:element.currentDiceFace,dayNumber:diffInDay};
        console.log(obj);
          arr.push(obj);
      });
